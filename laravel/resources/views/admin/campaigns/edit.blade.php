    ...
    <div class="col-xs-12">
      <div class="nav-tabs-page">
        ...
        <ul class="nav nav-tabs">
          ...
          {{-- <li><a href="#timestamps" data-toggle="tab" aria-expanded="false">Timestamps</a></li> --}}
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                          <div class="form-group">
                            <label for="upvo_prize">Prize</label>
                            <select name="_map_prize" id="upvo_prize" class="form-control"></select>
                          </div>
                        </div>
                      </div>
                    </div>
